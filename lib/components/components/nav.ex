defmodule HelloNerves.Component.Nav do
    ...
    graph =
      ...
      |> dropdown(
        {[
           ...
           {"Strokes", HelloNerves.Scene.Strokes},
           {"Components", HelloNerves.Scene.Components},
           {"Transforms", HelloNerves.Scene.Transforms},
           {"Sprites", HelloNerves.Scene.Sprites}
         ], current_scene},
        id: :nav,
        translate: {90, 10}
      )
